...
void AEnemy::Die()
{
	...
	if (AnimInstance && DeathtMontage)
	{
		AnimInstance->Montage_Play(DeathtMontage);
		...
		AnimInstance->Montage_JumpToSection(SectionName, DeathtMontage);
	}
	if (HealthBarWidget)
	{
		HealthBarWidget->SetVisibility(false);
...
void AEnemy::CheckPatrolTarget()
{
	if (InTargetRange(PatrolTarget, PatrolRadius))
	{
		...
		const float RandomWaitTime = FMath::FRandRange(WaitMin, WaitMax);
